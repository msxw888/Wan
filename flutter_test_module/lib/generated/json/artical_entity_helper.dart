...
articalEntityFromJson(ArticalEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
    data.data = ArticalData().fromJson(json['data']);
  }
...
Map<String, dynamic> articalEntityToJson(ArticalEntity entity) {
...
articalDataFromJson(ArticalData data, Map<String, dynamic> json) {
  ...
  if (json['datas'] != null) {
    data.datas = (json['datas'] as List)
        .map((v) => ArticalDataDatas().fromJson(v))
        .toList();
  }
  if (json['offset'] != null) {
...
Map<String, dynamic> articalDataToJson(ArticalData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
articalDataDatasFromJson(ArticalDataDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> articalDataDatasToJson(ArticalDataDatas entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
